...
-- =========================================================
-- KBG — ADMINISTRATEURS
-- Les droits admin sont stockés en base, pas dans le JavaScript.
-- =========================================================
...
-- Bootstrap : conserver les administrateurs actuels.
...
-- ---------------------------------------------------------
-- 2 BIS. GESTION DES ADMINISTRATEURS
-- ---------------------------------------------------------
...
select
  ...
  case
    when public.is_admin_user(u.id) then 'approved'
    when exists (
